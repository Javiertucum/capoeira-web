...
const COPY = {
  ...
  de: {
    ...
    appHeroEyebrow: 'Verfügbar bei Google Play',
    appHeroTitle: 'Deine Capoeira-Community in der Hosentasche',
    appHeroSubtitle: 'Anwesenheit, Graduierungen, Finanzen, Events und die globale Karte der Núcleos. Alles an einem Ort, für Lehrer und Schüler.',
    appHeroPlayButton: 'Bei Google Play herunterladen',
  ...
  it: {
    ...
    appHeroEyebrow: 'Disponibile su Google Play',
    appHeroTitle: 'Porta la tua comunità di capoeira in tasca',
    appHeroSubtitle: 'Presenze, graduazioni, finanze, eventi e la mappa globale dei núcleos. Tutto in un unico posto, per educatori e alunni.',
    appHeroPlayButton: 'Scarica su Google Play',
