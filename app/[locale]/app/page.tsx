...
const COPY = {
  es: {
    ...
    heading: 'La app se esta preparando sobre una web publica mucho mas util.',
    body:
    ...
    bullets: [
      'Busqueda publica mas clara',
      'Perfiles con mas contexto',
      'Mapa y lista pensados para movil',
    ],
  },
  pt: {
    title: 'App',
    eyebrow: 'Agenda Capoeiragem',
    heading: 'O app esta sendo preparado sobre uma web publica muito mais util.',
    body:
      'Antes de publicar os links finais de download, estamos fechando uma experiencia web que ja ajude a descobrir comunidades, educadores e espacos de treino com clareza.',
    primary: 'Explorar o diretorio',
    secondary: 'Voltar ao inicio',
    statusTitle: 'Estado atual',
    statusBody: 'A prioridade e que a web ja sirva como porta de entrada confiavel.',
    phoneTitle: 'Companion movel',
    bullets: [
      'Busca publica mais clara',
      'Perfis com mais contexto',
      'Mapa e lista pensados para movel',
    ],
  },
  en: {
    title: 'App',
