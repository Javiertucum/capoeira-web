      ...
      <div className="page-shell relative py-10">
        ...
        <div className="mt-6 grid grid-cols-1 gap-6 xl:grid-cols-[minmax(0,1fr)_390px] 2xl:grid-cols-[minmax(0,1.08fr)_420px] xl:items-start">
              ...
              <section className="rounded-[28px] border border-border bg-card/40 p-6 sm:p-8">
                <div className="grid gap-6 2xl:grid-cols-[260px_minmax(0,1fr)]">
                  <div className="space-y-4">
                    <div className="rounded-[24px] border border-border bg-card/70 px-5 py-5 text-center">
                      <div className="relative mx-auto h-32 w-32 overflow-hidden rounded-full border-4 border-border bg-card shadow-lg xl:h-40 xl:w-40">
                        {responsibleEducator.avatarUrl ? (
                          ...
                          <div className="flex h-full w-full items-center justify-center bg-surface text-3xl font-bold text-text-muted">
                    ...
                    {group ? (
                      <Link
                        href={`/${locale}/group/${groupId}`}
                        className="flex items-center gap-4 rounded-[24px] border border-border bg-card/70 px-4 py-4 transition-colors hover:border-accent/30"
                      >
                  ...
                  <div className="space-y-6">
                        ...
                        <div className="grid gap-3 sm:grid-cols-2">
                          {responsibleEducator.socialLinks.whatsapp ? (
                            <a
                              ...
                              className="flex items-center gap-3 rounded-xl border border-border bg-card/60 px-4 py-2.5 text-sm font-semibold text-text-secondary transition-all hover:border-[#25D366]/40 hover:bg-[#25D366]/5 hover:text-text"
                            >
                          ...
                          {responsibleEducator.socialLinks.instagram ? (
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="flex items-center gap-3 rounded-xl border border-border bg-card/60 px-4 py-2.5 text-sm font-semibold text-text-secondary transition-all hover:border-[#E4405F]/40 hover:bg-[#E4405F]/5 hover:text-text"
                            >
                          ...
                          {responsibleEducator.socialLinks.facebook ? (
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="flex items-center gap-3 rounded-xl border border-border bg-card/60 px-4 py-2.5 text-sm font-semibold text-text-secondary transition-all hover:border-[#1877F2]/40 hover:bg-[#1877F2]/5 hover:text-text"
                            >
                          ...
                          {responsibleEducator.socialLinks.youtube ? (
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="flex items-center gap-3 rounded-xl border border-border bg-card/60 px-4 py-2.5 text-sm font-semibold text-text-secondary transition-all hover:border-[#FF0000]/40 hover:bg-[#FF0000]/5 hover:text-text"
                            >
                          ...
                          {responsibleEducator.socialLinks.tiktok ? (
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="flex items-center gap-3 rounded-xl border border-border bg-card/60 px-4 py-2.5 text-sm font-semibold text-text-secondary transition-all hover:border-border hover:text-text"
                            >
                          ...
                          {responsibleEducator.socialLinks.website ? (
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="flex items-center gap-3 rounded-xl border border-border bg-card/60 px-4 py-2.5 text-sm font-semibold text-text-secondary transition-all hover:border-accent/40 hover:text-text"
                            >
                    ...
                    <Link
                      ...
                      className="inline-flex items-center gap-2 rounded-full border border-border bg-surface px-4 py-2 text-xs font-semibold uppercase tracking-widest text-text-secondary transition-colors hover:border-accent/30 hover:text-text"
                    >
                      {t('viewProfile')}
                    ...
                    if (member.role === 'educator') {
                      return (
                        <Link
                          ...
                          className="flex items-center gap-3 rounded-[18px] border border-border bg-surface px-4 py-3 transition-colors hover:border-accent/30"
                        >
                          {card}
                        </Link>
                      )
          ...
          <div className="space-y-5 xl:sticky xl:top-24 xl:self-start">
            ...
            <Link
              href={`/${locale}/group/${groupId}`}
              className="flex items-center gap-4 rounded-[22px] border border-border bg-card/40 px-5 py-4 transition-colors hover:border-accent/30"
            >
