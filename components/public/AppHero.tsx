          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-wrap items-center gap-4 pt-2 emil-enter-stagger emil-stagger-3">
              <a
                ...
                className="group inline-flex h-14 items-center gap-3 rounded-2xl bg-accent-solid px-8 text-sm font-bold text-white shadow-[0_6px_24px_-4px_oklch(0.56_0.19_158/0.4)] transition-[transform,box-shadow] duration-200 ease-[var(--ease-out)] hover:-translate-y-[2px] hover:shadow-[0_10px_32px_-4px_oklch(0.56_0.19_158/0.5)] active:scale-[0.97] active:translate-y-0"
              >
                <PlayBadgeIcon />
